            ...
            <Row noGutters={true} >
              ...
              <Col xs={12} xl={10}>
                ...
                <Form method='POST' action='/register' style={{padding: 0}}>
                  <Form.Row>
                    <Col>
                      <Form.Control placeholder='Usuario' style={{ backgroundColor: 'rgb(21, 32, 43)', color: 'white', borderColor: '#007bff'}} name='userId' onChange={(e)=>setName(e.target.value)}/>
                      <Form.Control type='hidden' name='name' value={name} />
                    </Col>
                    <Col>
